...
/* 25 */     return this.timer.passedMs(((Integer)HUD.INSTANCE.lagTime.getValue()).intValue());
/*    */   }
/*    */   
...
/*    */     }
/*    */     try {
/* 87 */       return ((NetHandlerPlayClient)Objects.<NetHandlerPlayClient>requireNonNull(mc.getConnection())).getPlayerInfo(mc.getConnection().getGameProfile().getId()).getResponseTime();
...
/* Location:              C:\Users\Administrator\Videos\remapped.jar!\me\abHack\manager\ServerManager.class
